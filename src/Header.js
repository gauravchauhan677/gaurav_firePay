            ...
            <div className="row">
                <div className="col-12 col-lg-6 header-left-side d-flex justify-content-center flex-column align-items-start order-lg-first order-last">
                    ...
                    <p className='main-hero-para'>
                        Lorem ipsum, dolor sit amet consectetur adipisicing elit. Dolores eaque tenetur cupiditate, consectetur natus non quae nam aperiam accusantium esse ipsum repellendus? Sequi perspiciatis totam minus, odit deleniti quas consequatur!
                    </p>
